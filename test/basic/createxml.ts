...
`
  ...
  test('create() without arguments', () =>
    __.eq(
      __.xml('test14').ele('node').txt('test').end(),
  ...
  test('create() with arguments', () =>
    __.eq(
      __.xml('test14', { 'version': '1.1' }).ele('node').txt('test').end(),
      '<?xml version="1.1"?><test14><node>test</node></test14>'
    )
  );

  test('create() with merged arguments', function() {
    __.eq(
      __.xml('test14', { version: '1.1', encoding: 'UTF-8', standalone: true, sysID: 'hello.dtd' })
    ...
    return __.eq(
      __.xml('test14', { headless: true, version: '1.1', encoding: 'UTF-8', standalone: true, sysID: 'hello.dtd' })
        .ele('node').txt('test').end(),
